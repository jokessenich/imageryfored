        ...
        return(
            <div>
                ...
                <div className="bottom-half">
                    <p className="p-introduction">ED is a condition that is often due to an issue in the relationship between the conscious and subconscious minds.
                    ...
                    {<br />}{<br />}A simplistic example of how this works with ED is that the conscious mind wants to have a sexual arousal, but the subconscious mind refuses. This refusal could be due to fear, anger, feelings of neglect, among many other things. These feelings grow because of the incongruence and frustration in the subconscious and conscious minds. We have now entered a negative reinforcement cycle (which feels like a negative spiral) between the conscious mind and subconscious mind.
                    {<br />}{<br />}
